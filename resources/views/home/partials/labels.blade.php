    ...
    <div class="mt-2">
        <div>
            <label class="inline-flex items-start">
                <input type="radio" class="form-radio mt-1" name="labels" value="" checked>
                <span class="ml-2">Ignore labels.</span>
            </label>
        </div>
        <div>
            <label class="inline-flex items-start">
                <input type="radio" class="form-radio mt-1" name="labels" value="gentle">
                <span class="ml-2">Only add new labels to the destination repo.</span>
            </label>
        </div>
        <div>
            <label class="inline-flex items-start">
                <input type="radio" class="form-radio mt-1" name="labels" value="aggressive">
                <span class="ml-2">
